...
// function PackBits(data:ByteArray,offset:Int, len:Int) : haxe.io.Bytes
 function PackBits(data:Dynamic,offset:Int, len:Int) : haxe.io.Bytes
   {
  ...
  // function ExtractBits(data:ByteArray,offset:Int, len:Int) : haxe.io.Bytes
   function ExtractBits(data:Dynamic,offset:Int, len:Int) : haxe.io.Bytes
   {
      var out = new haxe.io.BytesOutput();
      for(i in 0...len)
